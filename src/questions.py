#Réponse aux qeustion du projet 
...
def question_8():
    ...
    # J'avais mal lu la question mais utiles pour affichage streamlit peut-etre
...
def question_11():
    ...
    # recuperation des films de la vue crée précedement"high_rated_high_revenue_movies"
    ...
    if high_rated_movies:
        ...
        print("Aucun film trouvé avec un metascore sup à 80 et revenus sup à 50 millions.")
...
def question_12():
    ...
    if len(runtimes) > 1 and len(revenues) > 1:
        ...
        # figure
        plt.figure(figsize=(10, 6)) # test modifi d'ici pour streamlit
...
def question_22():
    ...
    if results:
        print("Top 5 acteurs qui a bosé avec le plus de réalisateurs différents :")
        for actor, nb in results:
            print(f"- {actor} : {nb} réalisateurs")
    else:
        print("0 acteur trouvé")
...
def question_23():
    ...
    if film:
        ...
        print(f"0 recommandation pour {actor_name}.")
...
def question_27():
    ...
    if results:
        print("Films avec genres communs mais realisatur différents :")
        for row in results:
...
def question_28():
    ...
    print(f"Films recommandé pour {actor_name} :")
